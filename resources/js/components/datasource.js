...
exports.getTradeData = exports.hierarchyOrderdata = exports.data1 = exports.orderDataSource = exports.employeeDetails = exports.orderDetails = exports.columnSpanData = exports.employeeData = exports.inventoryData = exports.data = exports.customerData = exports.categoryData = exports.orderData = exports.orderDatas = void 0;
...
var exportOrder = JSON.stringify([
    {
        'OrderID': 10248,
        'CustomerID': 'VINET',
        'CustomerName': 'Maria ',
...
var orderTemplateDetails = JSON.parse(exportOrder, function (field, value) {
    var dValue = value;
    if (typeof value === 'string' && /^(\d{4}\-\d\d\-\d\d([tT][\d:\.]*){1})([zZ]|([+\-])(\d\d):?(\d\d))?$/.test(value)) {
        var array = dValue.split(/[^0-9]/);
        value = new Date(parseInt(array[0], 10), parseInt(array[1], 10) - 1, parseInt(array[2], 10), parseInt(array[3], 10), parseInt(array[4], 10), parseInt(array[5], 10));
    }
    return value;
});
...
exports.data1 = exports.orderDataSource.map(function (item1) {
    var name1 = exports.customerData.filter(function (cItem1) {
